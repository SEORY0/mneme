...
- observed: 21 traces; solved: 1 (illustrative — not for ranking)
- top vuln_classes: other (12), out-of-bounds-read (3), use-of-uninitialized-value (2), global-buffer-overflow-read (1), null-pointer-dereference (1), out-of-bounds (1), stack-buffer-overflow (1)
