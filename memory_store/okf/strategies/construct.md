...
- canonical: `construct`
- observed: 1230 traces; solved: 472 (illustrative — not for ranking)
- top vuln_classes: other (304), heap-buffer-overflow-read (213), use-of-uninitialized-value (163), out-of-bounds-read (99), heap-buffer-overflow-write (64), use-after-free (54), out-of-bounds (44), null-pointer-dereference (36)
- top input_formats: pdf (62), mruby-script (18), mruby-source (12), elf (11), json (11), mvg (11), php-script (11), xml (9)
- collapsed aliases: construct-allocation-sweep, construct-and-malloc-sweep, construct-and-seed-from-geos-cases, construct-and-seed-informed, construct-and-seed-mutate, construct-and-seed-probe, construct-and-seed-sweep, construct-archive-carrier, construct-asn1-and-chunked-reader, construct-asn1-and-reader-chunks, construct-boundary, construct-carrier-wrap, construct-cil-policy-text, construct-cli-command, construct-cli-commands, construct-combined-object, construct-config, construct-corpus-directory-diagnostic-archive-carrier, construct-datasource-wrapped-flac, construct-differential-gated-gc, construct-direct-reader-chunks, construct-disassembler-frame, construct-elf-debug-addr-section, construct-elf-dwp, construct-elf-stub, construct-encrypted-xpath, construct-fdp-tail, construct-from-assembler-instruction-bytes, construct-from-description, construct-from-minimal-cil-seed, construct-from-repo-examples, construct-from-valid-seed, construct-geometry-radius, construct-hdlc-spinel, construct-hdlc-spinel-and-seed-mutate, construct-hdlc-spinel-streams, construct-html-allocator-limit, construct-icc-desc-tag, construct-ieee1905-message, construct-ini (+75 more)
<!-- END observed-census -->
