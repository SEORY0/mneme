...
- observed: 401 traces; solved: 114 (illustrative — not for ranking)
- top vuln_classes: other (91), heap-buffer-overflow-read (81), use-of-uninitialized-value (55), out-of-bounds-read (42), use-after-free (20), heap-buffer-overflow-write (16), out-of-bounds (14), buffer-overflow (11)
- top input_formats: opentype-font (20), rar5 (14), c-blosc2-frame (11), pdf (11), pe-dotnet (10), tiff (7), jpeg (5), jpeg-exif (4)
