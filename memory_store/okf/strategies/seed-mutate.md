...
- observed: 278 traces; solved: 45 (illustrative — not for ranking)
- top vuln_classes: other (60), use-of-uninitialized-value (45), heap-buffer-overflow-read (43), out-of-bounds-read (34), use-after-free (13), heap-buffer-overflow-write (11), out-of-bounds (11), buffer-overflow (8)
- top input_formats: opentype-font (12), c-blosc2-frame (8), pdf (8), rar5 (5), tiff (5), pe-dotnet (4), blosc2-frame (3), dwarf-object-debug-file (3)
