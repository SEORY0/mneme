...
- observed: 387 traces; solved: 107 (illustrative — not for ranking)
- top vuln_classes: other (87), heap-buffer-overflow-read (75), use-of-uninitialized-value (55), out-of-bounds-read (42), use-after-free (20), heap-buffer-overflow-write (15), out-of-bounds (14), buffer-overflow (11)
- top input_formats: opentype-font (19), rar5 (12), c-blosc2-frame (11), pdf (11), pe-dotnet (10), tiff (7), jpeg (5), opensc-pkcs15-reader-chunk-stream (4)
- collapsed aliases: construct-and-seed-mutate, construct-hdlc-spinel-and-seed-mutate, construct-seed-mutate, construct-seed-mutate-flow-control, construct-seed-mutate-metadata, construct-then-seed-mutate, construct-then-seed-mutate-then-xref-stream-retarget, regression-seed-mutate, seed-mutate-and-construct, seed-mutate-and-construct-postscript, seed-mutate-and-construct-tiff-ptif, seed-mutate-and-raw-layout-construct, seed-mutate-construct, seed-mutate-dxf-leader, seed-mutate-ftp-wildcard-tlv, seed-mutate-h264-then-mpegvideo-elementary-streams, seed-mutate-image-corpus, seed-mutate-nal-boundary-truncate-selector-mutate, seed-mutate-ncp-state-and-truncated-spinel, seed-mutate-plus-construct, seed-mutate-rar5-fixtures, seed-mutate-tail-flags, seed-mutate-then-construct, seed-mutate-then-construct-encrypted-xpath, seed-mutate-then-metadata-construct, seed-mutate-truncated-obu-header, seed-replay-seed-mutate-construct-rebuild, seed-sweep-seed-mutate-construct
<!-- END observed-census -->
