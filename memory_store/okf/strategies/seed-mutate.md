...
- observed: 427 traces; solved: 129 (illustrative — not for ranking)
- top vuln_classes: other (94), heap-buffer-overflow-read (91), use-of-uninitialized-value (57), out-of-bounds-read (44), use-after-free (22), heap-buffer-overflow-write (17), out-of-bounds (14), buffer-overflow (12)
- top input_formats: opentype-font (22), rar5 (14), pdf (12), c-blosc2-frame (11), pe-dotnet (10), tiff (8), opensc-pkcs15-reader-chunk-stream (6), opentype-variable-font (6)
