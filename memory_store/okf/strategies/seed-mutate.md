...
- observed: 437 traces; solved: 138 (illustrative — not for ranking)
- top vuln_classes: other (96), heap-buffer-overflow-read (95), use-of-uninitialized-value (58), out-of-bounds-read (44), use-after-free (22), heap-buffer-overflow-write (17), out-of-bounds (14), buffer-overflow (12)
- top input_formats: opentype-font (22), rar5 (14), c-blosc2-frame (13), pdf (12), pe-dotnet (11), tiff (8), jpeg (6), opensc-pkcs15-reader-chunk-stream (6)
