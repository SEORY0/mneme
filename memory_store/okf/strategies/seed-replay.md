...
- observed: 21 traces; solved: 5 (illustrative — not for ranking)
- top vuln_classes: use-of-uninitialized-value (7), other (5), out-of-bounds (2), heap-buffer-overflow-read (1), heap-buffer-overflow-write (1), invalid-free (1), null-pointer-dereference (1), out-of-bounds-read (1)
