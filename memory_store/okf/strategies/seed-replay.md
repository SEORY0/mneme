...
- observed: 23 traces; solved: 5 (illustrative — not for ranking)
- top vuln_classes: use-of-uninitialized-value (8), other (5), out-of-bounds (2), out-of-bounds-read (2), heap-buffer-overflow-read (1), heap-buffer-overflow-write (1), invalid-free (1), null-pointer-dereference (1)
