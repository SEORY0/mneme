---
type: causal-policy
title: No Crash ELF ELF Parser Reached Clean Exit Negative Memory
description: Negative memory for no_crash with elf_parser_reached_clean_exit on elf inputs.
failure_class: no_crash
verifier_signal: elf_parser_reached_clean_exit
candidate_family: construct
input_format: elf
harness_convention: libfuzzer
vuln_class: out-of-bounds-read-or-divide-by-zero
access_scope: generate
success_count: 0
confidence: medium
tags: [no-crash, elf-parser-reached-clean-exit, elf, out-of-bounds-read-or-divide-by-zero, construct, negative-memory]
match_keys: [no-crash, elf-parser-reached-clean-exit, elf, out-of-bounds-read-or-divide-by-zero, negative-memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash ELF ELF Parser Reached Clean Exit Negative Memory

- key: `no_crash x elf_parser_reached_clean_exit`
- outcome: persistent failure / basin to avoid
- success_count: 0
- failure_count: 1

## Failure Shape
A minimal relocatable ELF with a relocation section and inconsistent relocation metadata was
accepted without crashing. The input likely reached libbpf object opening but did not
satisfy the cross-section relation needed to drive relocation sanity-check failure.

## Policy
Treat `elf_parser_reached_clean_exit` after `no_crash` on `elf` as evidence that the candidate preserved or missed
