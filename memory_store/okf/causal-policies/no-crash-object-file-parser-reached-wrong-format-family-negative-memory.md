---
type: causal-policy
title: No Crash Object File Parser Reached Wrong Format Family Negative Memory
description: Negative memory for no_crash with parser_reached_wrong_format_family on object-file inputs.
failure_class: no_crash
verifier_signal: parser_reached_wrong_format_family
...
success_count: 0
confidence: medium
tags: [no-crash, parser-reached-wrong-format-family, object-file, stack-buffer-overflow-write, seed-mutate, negative-memory]
match_keys: [no-crash, parser-reached-wrong-format-family, object-file, stack-buffer-overflow-write, negative-memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash Object File Parser Reached Wrong Format Family Negative Memory

- key: `no_crash x parser_reached_wrong_format_family`
- outcome: persistent failure / basin to avoid
- success_count: 0
- failure_count: 1

## Failure Shape
The available ELF seed exercised objdump but did not enter the VMS Alpha private-
header/debug string printer. The missing gate is a valid Alpha VMS object envelope with DST
records whose string-printing command carries an inconsistent or insufficiently checked
length.

## Policy
Treat `parser_reached_wrong_format_family` after `no_crash` on `object-file` as evidence that the candidate preserved or missed
