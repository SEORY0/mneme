---
type: causal-policy
title: No Crash Ipv4 UDP Softether Packet Processed Clean Exit Negative Memory
description: Negative memory for no_crash with packet_processed_clean_exit on ipv4-udp-softether inputs.
failure_class: no_crash
verifier_signal: packet_processed_clean_exit
candidate_family: construct
input_format: ipv4-udp-softether
harness_convention: libfuzzer
vuln_class: heap-buffer-overflow-read
access_scope: generate
success_count: 0
confidence: medium
tags: [no-crash, packet-processed-clean-exit, ipv4-udp-softether, heap-buffer-overflow-read, construct, negative-memory]
match_keys: [no-crash, packet-processed-clean-exit, ipv4-udp-softether, heap-buffer-overflow-read, negative-memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash Ipv4 UDP Softether Packet Processed Clean Exit Negative Memory
...
## Failure Shape
A UDP packet carrying a SoftEther-like host/FQDN tuple executed successfully, so either
protocol classification did not enter the SoftEther dissector or the value-length relation
was still normalized before the described strncmp over-read.

## Policy
Treat `packet_processed_clean_exit` after `no_crash` on `ipv4-udp-softether` as evidence that the candidate preserved or missed
