---
type: causal-policy
title: No Crash Raw Camera Parser Reached No Target Crash Negative Memory
description: Negative memory for no_crash with parser_reached_no_target_crash on raw-camera inputs.
failure_class: no_crash
verifier_signal: parser_reached_no_target_crash
candidate_family: seed_mutate
input_format: raw-camera
harness_convention: libfuzzer
vuln_class: out-of-bounds-read
access_scope: generate
success_count: 0
confidence: medium
tags: [no-crash, parser-reached-no-target-crash, raw-camera, out-of-bounds-read, seed-mutate, negative-memory]
match_keys: [no-crash, parser-reached-no-target-crash, raw-camera, out-of-bounds-read, negative-memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash Raw Camera Parser Reached No Target Crash Negative Memory
...
## Failure Shape
RAF seed-family inputs reached LibRaw enough to report raw decoding errors, but did not
progress into x-trans demosaicing with an invalid pattern. The missing trigger is a Fuji or
X-Trans raw metadata mutation that remains unpackable and sets the X-Trans interpolation
mode while presenting an invalid color filter pattern.

## Policy
Treat `parser_reached_no_target_crash` after `no_crash` on `raw-camera` as evidence that the candidate preserved or missed
