---
type: causal-policy
title: No Crash Jpeg Xl Decoder Reached Clean Negative Memory
description: Negative memory for no_crash with decoder_reached_clean on jpeg-xl inputs.
failure_class: no_crash
verifier_signal: decoder_reached_clean
candidate_family: seed_mutate
input_format: jpeg-xl
harness_convention: libfuzzer
vuln_class: uninitialized-pixel-read-or-oob-rect
access_scope: generate
success_count: 0
confidence: medium
tags: [no-crash, decoder-reached-clean, jpeg-xl, uninitialized-pixel-read-or-oob-rect, seed-mutate, negative-memory]
match_keys: [no-crash, decoder-reached-clean, jpeg-xl, uninitialized-pixel-read-or-oob-rect, negative-memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash Jpeg Xl Decoder Reached Clean Negative Memory
...
## Failure Shape
A valid JXL seed decoded cleanly. Within the bounded attempts I did not construct a modular
extra-channel codestream with upsampling and odd or non-divisible extra-channel dimensions
to expose the rounded Rect edge condition.

## Policy
Treat `decoder_reached_clean` after `no_crash` on `jpeg-xl` as evidence that the candidate preserved or missed
