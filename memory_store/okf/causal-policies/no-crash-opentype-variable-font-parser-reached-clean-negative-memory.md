---
type: causal-policy
title: No Crash Opentype Variable Font Parser Reached Clean Negative Memory
description: Negative memory for no_crash with parser_reached_clean on opentype-variable-font inputs.
failure_class: no_crash
verifier_signal: parser_reached_clean
candidate_family: seed_mutate
input_format: opentype-variable-font
harness_convention: libfuzzer
vuln_class: unsanitized-variation-data-access
access_scope: generate
success_count: 0
confidence: medium
tags: [no-crash, parser-reached-clean, opentype-variable-font, unsanitized-variation-data-access, seed-mutate, negative-memory]
match_keys: [no-crash, parser-reached-clean, opentype-variable-font, unsanitized-variation-data-access, negative-memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash Opentype Variable Font Parser Reached Clean Negative Memory

- key: `no_crash x parser_reached_clean`
- outcome: persistent failure / basin to avoid
- success_count: 0
- failure_count: 1

## Failure Shape
Valid variable-font seeds and direct gvar tuple-data pointer mutations reached the font
parser but did not force the subset/shaping path to dereference unsanitized
TupleVariationData outside its valid blob bounds.

## Policy
Treat `parser_reached_clean` after `no_crash` on `opentype-variable-font` as evidence that the candidate preserved or missed
