---
type: causal-policy
title: No Crash Rar5 Parser Clean Exit Negative Memory
description: Negative memory for no_crash with verifier signal rar5_parser_clean_exit.
...
success_count: 0
confidence: medium
tags: [no-crash, rar5-parser-clean-exit, negative_memory]
match_keys: [no-crash, rar5-parser-clean-exit, negative_memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash Rar5 Parser Clean Exit Negative Memory
...
### Diagnosed Dead Ends
- RAR5 regression archives and truncation-oriented assets preserved the archive signature and exercised libarchive, but they were handled cleanly and did not reach a compressed-table state where declared table data outlived the available block bytes.
