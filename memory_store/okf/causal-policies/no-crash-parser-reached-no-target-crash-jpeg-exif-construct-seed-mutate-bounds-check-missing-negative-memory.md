---
type: causal-policy
title: "No Crash Parser Reached No Target Crash Jpeg Exif Construct Seed Mutate Bounds Check Missing Negative Memory"
...
success_count: 0
confidence: medium
tags: ["no-crash", "parser-reached-no-target-crash", "jpeg-exif", "negative-memory", "round-14"]
match_keys: ["no_crash", "parser_reached_no_target_crash", "jpeg-exif", "libfuzzer", "bounds-check-missing", "negative_memory"]
...
round: 14
---
# No Crash Parser Reached No Target Crash Jpeg Exif Construct Seed Mutate Bounds Check Missing Negative Memory
...
## Failure Shape
Minimal EXIF envelopes, endian variants, raw EXIF data, and a truncated real test JPEG did not reach the Apple maker-note value formatting path with a too-short length.

## Policy
Treat `no_crash x parser_reached_no_target_crash` on `jpeg-exif` as a basin to avoid unless a new candidate changes the parser gate, state relation, or official target sink. Preserve any proven reachability, but reject variants that return to the same verifier signal without changing the causal gate under test.
