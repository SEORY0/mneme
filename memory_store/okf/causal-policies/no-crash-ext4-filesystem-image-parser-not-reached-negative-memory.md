---
type: causal-policy
title: No Crash Ext4 Filesystem Image Parser Not Reached Negative Memory
description: Negative memory for no_crash with parser_not_reached on ext4-filesystem-image inputs.
failure_class: no_crash
verifier_signal: parser_not_reached
candidate_family: construct
input_format: ext4-filesystem-image
harness_convention: libfuzzer
vuln_class: integer-overflow-to-out-of-bounds-read
access_scope: generate
success_count: 0
confidence: medium
tags: [no-crash, parser-not-reached, ext4-filesystem-image, integer-overflow-to-out-of-bounds-read, construct, negative-memory]
match_keys: [no-crash, parser-not-reached, ext4-filesystem-image, integer-overflow-to-out-of-bounds-read, negative-memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash Ext4 Filesystem Image Parser Not Reached Negative Memory
...
## Failure Shape
A minimal ext-style image did not reach the inline-attribute loader. The hard gate is a
coherent filesystem image with a reachable inode carrying inline extended attributes, then
an attribute length or entry layout that overflows during inline attribute loading.

## Policy
Treat `parser_not_reached` after `no_crash` on `ext4-filesystem-image` as evidence that the candidate preserved or missed
