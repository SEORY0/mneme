---
type: causal-policy
title: No Crash Wkt Plus Wkb Split Stream Wkt Extra Text No Crash Negative Memory
description: Negative memory for no_crash with wkt_extra_text_no_crash on wkt plus wkb split stream inputs.
failure_class: no_crash
verifier_signal: wkt_extra_text_no_crash
candidate_family: construct
input_format: wkt plus wkb split stream
harness_convention: libfuzzer
vuln_class: semantic-parse-acceptance
access_scope: generate
success_count: 0
confidence: medium
tags: [no-crash, wkt-extra-text-no-crash, wkt-plus-wkb-split-stream, semantic-parse-acceptance, construct, negative-memory]
match_keys: [no-crash, wkt-extra-text-no-crash, wkt-plus-wkb-split-stream, semantic-parse-acceptance, negative-memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash Wkt Plus Wkb Split Stream Wkt Extra Text No Crash Negative Memory

- key: `no_crash x wkt_extra_text_no_crash`
- outcome: persistent failure / basin to avoid
- success_count: 0
- failure_count: 1

## Failure Shape
The candidate targeted acceptance of extra text after a WKT geometry while preserving the
split-stream shape expected by the harness. The parser behavior alone did not produce a
sanitizer or differential crash on the scoring surface.

## Policy
Treat `wkt_extra_text_no_crash` after `no_crash` on `wkt plus wkb split stream` as evidence that the candidate preserved or missed
