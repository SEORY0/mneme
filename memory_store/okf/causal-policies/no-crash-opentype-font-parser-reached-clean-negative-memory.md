---
type: causal-policy
title: No Crash Opentype Font Parser Reached Clean Negative Memory
description: Negative memory for no_crash with parser_reached_clean on opentype-font inputs.
failure_class: no_crash
verifier_signal: parser_reached_clean
candidate_family: seed_mutate
input_format: opentype-font
harness_convention: libfuzzer
vuln_class: size-calculation-overflow
access_scope: generate
success_count: 0
confidence: medium
tags: [no-crash, parser-reached-clean, opentype-font, size-calculation-overflow, seed-mutate, negative-memory]
match_keys: [no-crash, parser-reached-clean, opentype-font, size-calculation-overflow, negative-memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash Opentype Font Parser Reached Clean Negative Memory
...
## Failure Shape
Valid sfnt/font seeds reached the subset/layout harness, but stock corpus choices and
bounded mutations did not create the malformed layout-array size relationship needed to make
the DEFINE_SIZE_ARRAY_SIZED calculation wrap or undercount before access.

## Policy
Treat `parser_reached_clean` after `no_crash` on `opentype-font` as evidence that the candidate preserved or missed
