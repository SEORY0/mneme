---
type: causal-policy
title: No Crash Gml Graph Local Wrapper Usage Only Negative Memory
description: Negative memory for no_crash with local_wrapper_usage_only on gml graph inputs.
failure_class: no_crash
verifier_signal: local_wrapper_usage_only
candidate_family: seed_mutate
input_format: gml graph
harness_convention: honggfuzz-wrapper
vuln_class: heap-double-free
access_scope: generate
success_count: 0
confidence: medium
tags: [no-crash, local-wrapper-usage-only, gml-graph, heap-double-free, seed-mutate, negative-memory]
match_keys: [no-crash, local-wrapper-usage-only, gml-graph, heap-double-free, negative-memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash Gml Graph Local Wrapper Usage Only Negative Memory
...
## Failure Shape
A valid in-tree GML graph was used, but the local verifier surface printed the fuzz wrapper
usage path rather than evidence of parsing and graph cleanup. The double-free path was not
reached.

## Policy
Treat `local_wrapper_usage_only` after `no_crash` on `gml graph` as evidence that the candidate preserved or missed
