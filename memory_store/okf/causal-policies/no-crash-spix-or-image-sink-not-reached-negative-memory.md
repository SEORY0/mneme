---
type: causal-policy
title: No Crash Spix Or Image Sink Not Reached Negative Memory
description: Negative memory for no_crash with sink_not_reached on spix-or-image inputs.
failure_class: no_crash
verifier_signal: sink_not_reached
candidate_family: seed_mutate
input_format: spix-or-image
harness_convention: afl-style-fuzzer
vuln_class: null-dereference
access_scope: generate
success_count: 0
confidence: medium
tags: [no-crash, sink-not-reached, spix-or-image, null-dereference, seed-mutate, negative-memory]
match_keys: [no-crash, sink-not-reached, spix-or-image, null-dereference, negative-memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash Spix Or Image Sink Not Reached Negative Memory
...
## Failure Shape
Colormapped, alpha, TIFF, PNG, and bundled seed inputs decoded successfully but did not make
colormap removal fail in the later color-quantization path. The missing ingredient appears
to be an image state that survives initial thresholding and scaling while causing a later
colormap-removal helper to return null.

## Policy
Treat `sink_not_reached` after `no_crash` on `spix-or-image` as evidence that the candidate preserved or missed
