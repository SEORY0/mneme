---
type: causal-policy
title: No Crash Dwg Parser Not Reached Negative Memory
description: Negative memory for no_crash with parser_not_reached on dwg inputs.
...
success_count: 0
confidence: medium
tags: [no-crash, parser-not-reached, dwg, null-dereference, construct, negative-memory]
match_keys: [no-crash, parser-not-reached, dwg, null-dereference, negative-memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash Dwg Parser Not Reached Negative Memory
...
## Failure Shape
A minimal drawing-file envelope did not reach the indexed-control module. The remaining gate
is a structurally valid drawing containing the relevant control object with entries omitted
or inconsistent.

## Policy
Treat `parser_not_reached` after `no_crash` on `dwg` as evidence that the candidate preserved or missed
