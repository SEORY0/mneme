---
type: causal-policy
title: No Crash Png Image Parser Reached Clean Exit Negative Memory
description: Negative memory for no_crash with image_parser_reached_clean_exit on png inputs.
failure_class: no_crash
verifier_signal: image_parser_reached_clean_exit
...
success_count: 0
confidence: medium
tags: [no-crash, image-parser-reached-clean-exit, png, heap-buffer-overflow-read, construct, negative-memory]
match_keys: [no-crash, image-parser-reached-clean-exit, png, heap-buffer-overflow-read, negative-memory]
allowed_scopes: [generate]
forbidden_fields: [raw_poc_bytes, task_id, exact_offset, checksum, submit_metadata]
evidence_level: medium
train_only: true
---
# No Crash Png Image Parser Reached Clean Exit Negative Memory

- key: `no_crash x image_parser_reached_clean_exit`
- outcome: persistent failure / basin to avoid
- success_count: 0
- failure_count: 1

## Failure Shape
Paletted PNG inputs reached Leptonica image parsing, but the selected enhancement harness
rejected or short-circuited colormapped and low-bit-depth images before the
pixGetRGBComponentCmap colormap-index invariant became active.

## Policy
Treat `image_parser_reached_clean_exit` after `no_crash` on `png` as evidence that the candidate preserved or missed
