...
- observed: 35 traces; solved: 22 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (23), afl (2), afl-file (1), afl-libfuzzer-file-through-gpac-probe-analyze-filter-graph (1), honggfuzz-libfuzzer-compat (1), honggfuzz-libfuzzer-file-input-to-pkcs15-reader (1), libfuzzer-binutils-disassembler (1), libfuzzer-compatible (1)
- observed strategies: construct (30), seed-mutate (6)
<!-- END observed-census -->
