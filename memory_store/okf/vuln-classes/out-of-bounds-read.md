...
- observed: 146 traces; solved: 29 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (93), afl-libfuzzer-wrapper (3), libfuzzer-ffmpeg-target-decoder (3), honggfuzz-wrapper (2), afl-compatible-fuzzer (1), afl-file-openjpeg-decompress (1), afl-fuzzshark-ip (1), afl-hb-draw-fuzzer (1)
- observed strategies: construct (97), seed-mutate (42), seed-sweep (7), analysis-only (3), other (3), tiny-probe (3), seed-replay (2)
