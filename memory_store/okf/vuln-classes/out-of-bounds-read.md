...
- observed: 154 traces; solved: 32 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (98), afl-libfuzzer-wrapper (3), libfuzzer-ffmpeg-target-decoder (3), afl-hb-draw-fuzzer (2), honggfuzz-wrapper (2), afl-compatible-fuzzer (1), afl-file-openjpeg-decompress (1), afl-fuzzshark-ip (1)
- observed strategies: construct (103), seed-mutate (44), seed-sweep (7), analysis-only (3), other (3), tiny-probe (3), seed-replay (2)
