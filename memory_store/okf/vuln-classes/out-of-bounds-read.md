...
- observed: 136 traces; solved: 25 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (87), afl-libfuzzer-wrapper (3), honggfuzz-wrapper (2), libfuzzer-ffmpeg-target-decoder (2), afl-compatible-fuzzer (1), afl-file-openjpeg-decompress (1), afl-fuzzshark-ip (1), afl-hb-draw-fuzzer (1)
- observed strategies: construct (90), seed-mutate (37), seed-sweep (6), analysis-only (3), other (3), tiny-probe (2), seed-replay (1)
