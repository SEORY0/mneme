...
- observed: 130 traces; solved: 21 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (86), afl-libfuzzer-wrapper (3), honggfuzz-wrapper (2), afl-compatible-fuzzer (1), afl-file-openjpeg-decompress (1), afl-fuzzshark-ip (1), afl-hb-draw-fuzzer (1), afl-libfuzzer-compatible-raw-file (1)
- observed strategies: construct (86), seed-mutate (35), seed-sweep (6), analysis-only (3), other (3), tiny-probe (2), seed-replay (1)
