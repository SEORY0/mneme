...
- observed: 132 traces; solved: 22 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (86), afl-libfuzzer-wrapper (3), honggfuzz-wrapper (2), afl-compatible-fuzzer (1), afl-file-openjpeg-decompress (1), afl-fuzzshark-ip (1), afl-hb-draw-fuzzer (1), afl-libfuzzer-compatible (1)
- observed strategies: construct (87), seed-mutate (36), seed-sweep (6), analysis-only (3), other (3), tiny-probe (2), seed-replay (1)
