...
- observed: 151 traces; solved: 30 (illustrative — not for ranking)
- top input_formats: pdf (5), ac3-eac3-audio-frame (3), ecoff-bfd-object (3), http-request (3), opensc-pkcs15-reader-chunk-stream (3), opentype-font (3), binutils-disassembler-buffer-with-trailing-selectors (2), fuzzing-datasource-rsa-fields (2)
- top harnesses: libfuzzer (96), afl-libfuzzer-wrapper (3), libfuzzer-ffmpeg-target-decoder (3), afl-hb-draw-fuzzer (2), honggfuzz-wrapper (2), afl-compatible-fuzzer (1), afl-file-openjpeg-decompress (1), afl-fuzzshark-ip (1)
- observed strategies: construct (100), seed-mutate (44), seed-sweep (7), analysis-only (3), other (3), tiny-probe (3), seed-replay (2)
