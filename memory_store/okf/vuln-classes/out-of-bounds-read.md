...
- observed: 140 traces; solved: 27 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (89), afl-libfuzzer-wrapper (3), honggfuzz-wrapper (2), libfuzzer-ffmpeg-target-decoder (2), afl-compatible-fuzzer (1), afl-file-openjpeg-decompress (1), afl-fuzzshark-ip (1), afl-hb-draw-fuzzer (1)
- observed strategies: construct (92), seed-mutate (39), seed-sweep (7), analysis-only (3), other (3), tiny-probe (3), seed-replay (1)
