...
- observed: 55 traces; solved: 7 (illustrative — not for ranking)
- top input_formats: aac-usac-mps (2), rawspeed-decompressor-envelope (2), aac-bitstream (1), ac3 (1), asn1-der-rsa-key (1), bmp (1), cram (1), ecoff-bfd-object (1)
- top harnesses: libfuzzer (31), afl-file (2), fuzzshark-ip (2), afl-compatible-raw-import-fuzzer (1), afl-libfuzzer-compatible-raw-stdin (1), afl-libfuzzer-file (1), afl-libfuzzer-wrapper (1), afl-style-file (1)
- observed strategies: construct (40), seed-mutate (11), other (3), seed-replay (2), seed-sweep (1), tiny-probe (1)
