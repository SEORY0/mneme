...
- observed: 63 traces; solved: 14 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (34), libfuzzer-ffmpeg-target-decoder (3), afl-file (2), fuzzshark-ip (2), libfuzzer-ffmpeg-target-dec-fuzzer (2), afl-compatible-raw-import-fuzzer (1), afl-libfuzzer-compatible-raw-stdin (1), afl-libfuzzer-file (1)
- observed strategies: construct (44), seed-mutate (14), other (4), seed-replay (2), seed-sweep (1), tiny-probe (1)
