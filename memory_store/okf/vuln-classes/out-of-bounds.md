...
- observed: 57 traces; solved: 9 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (32), afl-file (2), fuzzshark-ip (2), afl-compatible-raw-import-fuzzer (1), afl-libfuzzer-compatible-raw-stdin (1), afl-libfuzzer-file (1), afl-libfuzzer-wrapper (1), afl-style-file (1)
- observed strategies: construct (40), seed-mutate (13), other (3), seed-replay (2), seed-sweep (1), tiny-probe (1)
