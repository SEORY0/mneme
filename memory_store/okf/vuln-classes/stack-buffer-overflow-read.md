...
- observed: 19 traces; solved: 14 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (12), afl-file (1), afl-fuzzshark (1), fuzzshark-ip (1), libfuzzer-ndpi-process-packet (1), libfuzzer-pkcs15-reader (1), libfuzzer-qpdf (1), libfuzzer-whole-buffer-libraw (1)
- observed strategies: construct (17), seed-mutate (2)
<!-- END observed-census -->
