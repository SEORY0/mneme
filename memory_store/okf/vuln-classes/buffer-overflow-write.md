...
- observed: 16 traces; solved: 3 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (5), afl-libfuzzer-wrapper (2), afl-fuzzshark-ip-proto-udp (1), afl-raw-stdin (1), gstoraster-fuzzer (1), hb-subset-fuzzer (1), honggfuzz (1), honggfuzz-file (1)
- observed strategies: construct (11), seed-mutate (4), seed-sweep (1)
