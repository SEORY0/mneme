...
- observed: 229 traces; solved: 132 (illustrative — not for ranking)
- top input_formats: c-blosc2-frame (7), json (7), bmp (5), hunspell-aff-dic-word-triple (4), sip-message (4), elf (3), mruby-source (3), opentype-font (3)
- top harnesses: libfuzzer (143), honggfuzz-file (4), afl-file (3), honggfuzz-wrapper (3), afl (2), afl-libfuzzer (2), afl-libfuzzer-compatible (2), afl-libfuzzer-wrapper (2)
- observed strategies: construct (174), seed-mutate (56), other (1), seed-replay (1), seed-sweep (1)
