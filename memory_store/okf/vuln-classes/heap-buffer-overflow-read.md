...
- observed: 265 traces; solved: 161 (illustrative — not for ranking)
- top input_formats: c-blosc2-frame (7), json (7), bmp (5), opentype-font (5), hunspell-aff-dic-word-triple (4), sip-message (4), elf (3), git-raw-object (3)
- top harnesses: libfuzzer (159), honggfuzz-file (4), afl (3), afl-file (3), honggfuzz-wrapper (3), libfuzzer-harfbuzz-shape-fuzzer (3), libfuzzer-tempfile-bfd (3), afl-libfuzzer (2)
- observed strategies: construct (201), seed-mutate (70), other (1), seed-replay (1), seed-sweep (1)
