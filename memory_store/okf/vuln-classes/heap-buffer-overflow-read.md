...
- observed: 239 traces; solved: 141 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (148), honggfuzz-file (4), afl-file (3), honggfuzz-wrapper (3), afl (2), afl-libfuzzer (2), afl-libfuzzer-compatible (2), afl-libfuzzer-wrapper (2)
- observed strategies: construct (182), seed-mutate (59), other (1), seed-replay (1), seed-sweep (1)
