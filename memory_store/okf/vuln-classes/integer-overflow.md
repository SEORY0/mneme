...
- observed: 32 traces; solved: 4 (illustrative — not for ranking)
- top input_formats: aac-loas-latm (2), audio-container (2), sctp-packet (2), bcachefs-filesystem-image (1), blosc2-frame (1), c-blosc2-frame (1), cryptofuzz-binary-operation-stream (1), dwg-r11 (1)
- top harnesses: libfuzzer (17), afl-file (1), afl-libfuzzer-compatible-whole-buffer-frame-decompressor (1), afl-standalone-loas-decoder (1), afl-stdin-libfuzzer-wrapper (1), afl-style-usrsctp-listen-fuzzer (1), decompress-frame-fuzzer (1), libfuzzer-assimp-importer (1)
- observed strategies: construct (22), seed-mutate (12), other (1), seed-sweep (1)
