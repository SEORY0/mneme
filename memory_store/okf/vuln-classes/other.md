...
- canonical: `other`
- observed: 346 traces; solved: 37 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (186), honggfuzz (6), libfuzzer-file-command-wrapper (4), libfuzzer-mupdf-pdf-renderer (4), afl-file-wrapper (3), afl-libfuzzer (3), libfuzzer-gstoraster (3), libfuzzer-mruby-load-string (3)
- observed strategies: construct (252), seed-mutate (64), seed-sweep (11), tiny-probe (11), analysis-only (9), other (6), seed-replay (5), fuzzer (1)
