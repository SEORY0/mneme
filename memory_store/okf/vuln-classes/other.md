...
- canonical: `other`
- observed: 367 traces; solved: 49 (illustrative — not for ranking)
- top input_formats: pdf (20), mruby-script (10), opentype-font (7), upx-packed-elf (6), opensc-virtual-reader-chunk-stream (5), heif-isobmff (4), icc-profile (4), jpeg (4)
- top harnesses: libfuzzer (199), honggfuzz (6), libfuzzer-mupdf-pdf-renderer (5), libfuzzer-file-command-wrapper (4), afl-file-wrapper (3), afl-libfuzzer (3), libfuzzer-gstoraster (3), libfuzzer-mruby-load-string (3)
- observed strategies: construct (270), seed-mutate (71), seed-sweep (13), tiny-probe (11), analysis-only (9), other (6), seed-replay (5), fuzzer (1)
