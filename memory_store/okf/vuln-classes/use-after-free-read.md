...
- observed: 13 traces; solved: 12 (illustrative — not for ranking)
- top input_formats: mosquitto-config-text (2), pdf (2), data-url (1), ipv4-gre-ieee80211-amsdu (1), openpgp-signed-message (1), php (1), php-script (1), php-source (1)
- top harnesses: libfuzzer (8), libfuzzer-execute (1), libfuzzer-fuzzshark-ip (1), libfuzzer-gstoraster-stdin (1), libfuzzer-raw-memory (1), libfuzzer-url-parser (1)
- observed strategies: construct (11), seed-mutate (2)
