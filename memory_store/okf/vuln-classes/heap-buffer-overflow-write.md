...
- observed: 75 traces; solved: 48 (illustrative — not for ranking)
- top input_formats: ar-archive (3), dwg (2), elf (2), mvg (2), pdf (2), aac-usac (1), arrow-ipc-stream (1), bfd-object (1)
...
- observed strategies: construct (61), seed-mutate (15), seed-sweep (2), seed-replay (1)
