...
- top input_formats: pdf (6), cil-policy-text (4), xml (3), html (2), libxml2-valid-fuzzer-envelope (2), opentype-font (2), xml-xinclude-fuzzer-envelope (2), ar-archive-with-pdb-member (1)
- top harnesses: libfuzzer (45), afl-file (2), afl (1), afl-file-fuzzer (1), afl-libfuzzer-file (1), afl-style-file-fuzzer-for-kimgio-karchive (1), honggfuzz-style-libxml2-fuzzer (1), libarchive-fuzzer (1)
- observed strategies: construct (46), seed-mutate (13), seed-sweep (3), analysis-only (2), other (1), seed-replay (1)
