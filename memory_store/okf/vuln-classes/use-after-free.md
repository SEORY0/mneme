...
- observed: 80 traces; solved: 22 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (53), afl-file (2), afl-libfuzzer-file (2), afl (1), afl-file-fuzzer (1), afl-libfuzzer-compat-html (1), afl-style-file-fuzzer-for-kimgio-karchive (1), honggfuzz-file (1)
- observed strategies: construct (55), seed-mutate (22), seed-sweep (4), analysis-only (2), other (1), seed-replay (1)
