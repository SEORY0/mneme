...
- observed: 78 traces; solved: 21 (illustrative — not for ranking)
- top input_formats: pdf (6), cil-policy-text (4), rar (3), xml (3), html (2), libxml2-valid-fuzzer-envelope (2), opentype-font (2), wget-config (2)
- top harnesses: libfuzzer (52), afl-file (2), afl-libfuzzer-file (2), afl (1), afl-file-fuzzer (1), afl-style-file-fuzzer-for-kimgio-karchive (1), honggfuzz-file (1), honggfuzz-style-libxml2-fuzzer (1)
- observed strategies: construct (54), seed-mutate (20), seed-sweep (4), analysis-only (2), other (1), seed-replay (1)
