...
- observed: 74 traces; solved: 20 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (51), afl-file (2), afl (1), afl-file-fuzzer (1), afl-libfuzzer-file (1), afl-style-file-fuzzer-for-kimgio-karchive (1), honggfuzz-style-libxml2-fuzzer (1), libarchive-fuzzer (1)
- observed strategies: construct (51), seed-mutate (18), seed-sweep (4), analysis-only (2), other (1), seed-replay (1)
