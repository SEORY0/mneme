...
- observed: 183 traces; solved: 52 (illustrative — not for ranking)
- top input_formats: pdf (12), hevc-elementary-stream (5), capstone-disasm-selector-plus-bytes (3), ffmpeg-target-decoder-frame (3), spix (3), iamf (2), ipv4-tcp-tls (2), miff (2)
- top harnesses: libfuzzer (118), libfuzzer-ffmpeg-target-decoder (8), oss-fuzz-run-poc-ffmpeg-target-decoder (3), afl-libfuzzer-file (2), file-parser (2), libfuzzer-ffmpeg-demuxer (2), libfuzzer-msan (2), libfuzzer-raw-pdf-renderer (2)
- observed strategies: construct (132), seed-mutate (49), seed-replay (5), seed-sweep (3), analysis-only (2), other (2), tiny-probe (2)
