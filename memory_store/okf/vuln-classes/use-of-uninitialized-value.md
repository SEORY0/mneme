...
- observed: 202 traces; solved: 65 (illustrative — not for ranking)
- top input_formats: pdf (13), hevc-elementary-stream (5), capstone-disasm-selector-plus-bytes (3), ffmpeg-target-decoder-frame (3), php-script (3), spix (3), binutils-disassembler-buffer-with-trailer-selector (2), ffmpeg-aic-target-decoder-packet (2)
- top harnesses: libfuzzer (128), libfuzzer-ffmpeg-target-decoder (9), oss-fuzz-run-poc-ffmpeg-target-decoder (6), libfuzzer-ffmpeg-demuxer (3), afl-libfuzzer-file (2), file-parser (2), libfuzzer-gpsd-fuzzpacket (2), libfuzzer-msan (2)
- observed strategies: construct (146), seed-mutate (54), seed-replay (6), seed-sweep (4), analysis-only (2), other (2), tiny-probe (2)
