...
- observed: 231 traces; solved: 89 (illustrative — not for ranking)
- top input_formats: pdf (18), hevc-elementary-stream (6), capstone-disasm-selector-plus-bytes (5), php-script (4), binutils-disassembler-buffer-with-trailer-selector (3), ffmpeg-target-decoder-frame (3), miff (3), spix (3)
- top harnesses: libfuzzer (148), libfuzzer-ffmpeg-target-decoder (9), oss-fuzz-run-poc-ffmpeg-target-decoder (6), libfuzzer-ffmpeg-demuxer (3), afl-libfuzzer-compatible (2), afl-libfuzzer-file (2), file-parser (2), honggfuzz-libfuzzer-php-parser-raw-source (2)
- observed strategies: construct (172), seed-mutate (56), seed-replay (8), seed-sweep (5), analysis-only (2), other (2), tiny-probe (2)
