...
- observed: 248 traces; solved: 103 (illustrative — not for ranking)
- top input_formats: pdf (19), hevc-elementary-stream (6), capstone-disasm-selector-plus-bytes (5), spix (5), php-script (4), binutils-disassembler-buffer-with-trailer-selector (3), cryptofuzz-binary-operation-stream (3), ffmpeg-target-decoder-frame (3)
- top harnesses: libfuzzer (160), libfuzzer-ffmpeg-target-decoder (9), oss-fuzz-run-poc-ffmpeg-target-decoder (6), libfuzzer-ffmpeg-demuxer (3), afl-libfuzzer-compatible (2), afl-libfuzzer-file (2), file-parser (2), honggfuzz-libfuzzer-php-parser-raw-source (2)
- observed strategies: construct (185), seed-mutate (60), seed-replay (9), seed-sweep (5), analysis-only (2), other (2), tiny-probe (2)
- collapsed aliases: assertion-failure-or-uninitialized-read, memory-sanitizer-use-of-uninitialized-value, memory-uninitialized-use, memorysanitizer-use-of-uninitialized-value, miniz-distance-copy-uninitialized-value, null-or-uninitialized-font-state, out-of-bounds-read-or-uninitialized-read, progressive-jpeg-uninitialized-read, tls-certificate-printable-string-uninitialized-memory, undefined-behavior-null-or-uninitialized-state, undefined-behavior-uninitialized-value, uninitialized-bigint-copy, uninitialized-buffer-read, uninitialized-field-use, uninitialized-free-or-undefined-behavior, uninitialized-hook-pointer-dereference, uninitialized-memory, uninitialized-memory-fuzzer-only-canvas-flag-misuse, uninitialized-memory-read, uninitialized-null-device-after-allocation-failure, uninitialized-opacity-channel, uninitialized-opacity-read, uninitialized-or-invalid-alpha-handling, uninitialized-or-out-of-bounds-read, uninitialized-or-wrong-class-pixel-use, uninitialized-pixel-read-or-oob-rect, uninitialized-pointer-free, uninitialized-pointer-use, uninitialized-read, uninitialized-size-or-state, uninitialized-stack, uninitialized-stack-data-access, uninitialized-stack-object-use, uninitialized-stack-read, uninitialized-stack-struct-use, uninitialized-state-after-serialization-failure, uninitialized-value, uninitialized-value-read, uninitialized-value-use, uninitialized-video-buffer (+7 more)
<!-- END observed-census -->
