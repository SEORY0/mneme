...
- observed: 201 traces; solved: 64 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (127), libfuzzer-ffmpeg-target-decoder (9), oss-fuzz-run-poc-ffmpeg-target-decoder (6), libfuzzer-ffmpeg-demuxer (3), afl-libfuzzer-file (2), file-parser (2), libfuzzer-gpsd-fuzzpacket (2), libfuzzer-msan (2)
- observed strategies: construct (145), seed-mutate (54), seed-replay (6), seed-sweep (4), analysis-only (2), other (2), tiny-probe (2)
