...
- observed: 244 traces; solved: 101 (illustrative — not for ranking)
- top input_formats: pdf (19), hevc-elementary-stream (6), capstone-disasm-selector-plus-bytes (5), spix (5), php-script (4), binutils-disassembler-buffer-with-trailer-selector (3), ffmpeg-target-decoder-frame (3), miff (3)
- top harnesses: libfuzzer (158), libfuzzer-ffmpeg-target-decoder (9), oss-fuzz-run-poc-ffmpeg-target-decoder (6), libfuzzer-ffmpeg-demuxer (3), afl-libfuzzer-compatible (2), afl-libfuzzer-file (2), file-parser (2), honggfuzz-libfuzzer-php-parser-raw-source (2)
- observed strategies: construct (182), seed-mutate (58), seed-replay (9), seed-sweep (5), analysis-only (2), other (2), tiny-probe (2)
