...
- observed: 31 traces; solved: 12 (illustrative — not for ranking)
- top input_formats: tiff-ojpeg-image (3), fluent-bit-parser-fuzzer-control-plus-record (2), pcap-filter-expression (2), argv-envelope-plus-virtual-smart-card-apdu-trace (1), art (1), bfd-vms-alpha-archive-or-object (1), bfd-vms-library-object (1), cil-policy-text (1)
- top harnesses: libfuzzer (17), honggfuzz-wrapper (2), afl (1), afl-libfuzzer (1), honggfuzz-file (1), honggfuzz-style-file-fuzzer (1), libfuzzer-afl-file-wrapper (1), libfuzzer-bfd (1)
- observed strategies: construct (21), seed-mutate (9), other (1)
