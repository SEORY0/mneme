...
- observed: 27 traces; solved: 10 (illustrative — not for ranking)
- top input_formats: fluent-bit-parser-fuzzer-control-plus-record (2), pcap-filter-expression (2), tiff-ojpeg-image (2), argv-envelope-plus-virtual-smart-card-apdu-trace (1), art (1), bfd-vms-library-object (1), cil-policy-text (1), dxf-or-json-cad (1)
- top harnesses: libfuzzer (14), honggfuzz-wrapper (2), afl (1), afl-libfuzzer (1), honggfuzz-file (1), honggfuzz-style-file-fuzzer (1), libfuzzer-afl-file-wrapper (1), libfuzzer-bfd (1)
- observed strategies: construct (19), seed-mutate (7), other (1)
