...
- observed: 30 traces; solved: 12 (illustrative — not for ranking)
...
- top harnesses: libfuzzer (16), honggfuzz-wrapper (2), afl (1), afl-libfuzzer (1), honggfuzz-file (1), honggfuzz-style-file-fuzzer (1), libfuzzer-afl-file-wrapper (1), libfuzzer-bfd (1)
- observed strategies: construct (20), seed-mutate (9), other (1)
